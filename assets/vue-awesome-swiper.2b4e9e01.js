...
`};var _h=Object.keys(Cs).map(s=>({component:Cs[s].default,raw:vh[s],language:"vue"}));const Sh={class:"page"},bh={class:"swiper-example"},yh=R({setup(s){const e=nt.VueAwesomeSwiper,t=_h.map(Ct);return lt({title:ft(e),keywords:[mt(e),"How to use Swiper on vue3?"].join(","),description:ht(e)}),(i,l)=>(O(),W("div",Sh,[m(Un,{repository:oe(e)},{actions:f(()=>[m(Be,{icon:"doc",text:"Vue(2) examples",href:oe(at)(oe(e))},null,8,["href"]),m(Be,{icon:"doc",text:"Swiper API Documentation",href:"https://swiperjs.com/swiper-api"}),m(Be,{icon:"doc",text:"Swiper Vue(3) component",href:"https://swiperjs.com/vue"}),m(Be,{icon:"discussions",text:"Swiper discussions",href:"https://github.com/nolimits4web/swiper/discussions"})]),content:f(()=>[m(gl,{examples:oe(t)},{component:f(n=>[E("div",bh,[(O(),V($t(n.component)))])]),_:1},8,["examples"])]),_:1},8,["repository"])]))}});var Ph=H(yh,[["__scopeId","data-v-409b80d1"]]);export{Ph as default};
