...
`};var ch=Object.keys(xs).map(s=>({component:xs[s].default,raw:ph[s],language:"vue"}));const uh={class:"page"},fh={class:"swiper-example"},mh=R({setup(s){const e=rt.VueAwesomeSwiper,t=ch.map($t);return nt({title:ct(e),keywords:[ut(e),"How to use Swiper on vue3?"].join(","),description:ft(e)}),(i,l)=>(O(),W("div",uh,[m(Rn,{repository:ce(e)},{actions:f(()=>[m(Be,{icon:"doc",text:"Swiper API Document",href:"https://swiperjs.com/swiper-api"}),m(Be,{icon:"doc",text:"Swiper Vue component",href:"https://swiperjs.com/vue"}),m(Be,{icon:"doc",text:"Original Swiper Demos",href:"https://swiperjs.com/demos"}),m(Be,{icon:"discussions",text:"Swiper discussions",href:"https://github.com/nolimits4web/swiper/discussions"})]),content:f(()=>[m(dl,{examples:ce(t)},{component:f(n=>[E("div",fh,[(O(),V(bt(n.component)))])]),_:1},8,["examples"])]),_:1},8,["repository"])]))}});var bh=H(mh,[["__scopeId","data-v-1275a0f7"]]);export{bh as default};
