...
`,factory=async()=>{const e=window.segmentit??await __vitePreload(()=>import("./segmentit-QF0DN6UE.js"),__vite__mapDeps([]));window.segmentit=e;const{Segment:n,useDefault:o}=e,s=o(new n);return new NaiveBayes$1({tokenizer(t){return s.doSegment(t.replace(/[^(a-zA-Z\u4e00-\u9fa50-9_)+\s]/g," "),{simple:!0})}})},code$2=dedent`
// 正常邮件
const HAM = '正常邮件'
