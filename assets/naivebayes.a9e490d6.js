import{_ as __vitePreload,d as defineComponent,z as ref,r as reactive,l as computed,D as onMounted,E as watch,H as nextTick,j as useTheme,q as Theme,s as resolveComponent,a as openBlock,c as createElementBlock,e as createBaseVNode,I as withDirectives,J as vModelSelect,F as Fragment,i as renderList,t as toDisplayString,x as createCommentVNode,m as createVNode,v as createTextVNode,p as pushScopeId,b as popScopeId,R as Repository,u as useMeta,f as createBlock,w as withCtx,g as unref,K as resolveDynamicComponent}from"./index.5bbbf6dc.js";import{g as getExampleComponent,H as Homepage}from"./index.76c31aae.js";import{g as getMetaTitle,a as getMetaKeywords,b as getMetaDescription}from"./navbar.d0863441.js";import{V as VueRenderer}from"./vue.f6757121.js";import{H as HomepageExamples}from"./examples.ef7d30e7.js";import{F,j as javascript,o as oneDark}from"./index.4b2436cb.js";import{_ as _export_sfc}from"./plugin-vue_export-helper.21dcd24c.js";var dedent$1={exports:{}};(function(e){function n(o){var s=void 0;typeof o=="string"?s=[o]:s=o.raw;for(var a="",t=0;t<s.length;t++)a+=s[t].replace(/\\\n[ \t]*/g,"").replace(/\\`/g,"`"),t<(arguments.length<=1?0:arguments.length-1)&&(a+=arguments.length<=t+1?void 0:arguments[t+1]);var l=a.split(`
