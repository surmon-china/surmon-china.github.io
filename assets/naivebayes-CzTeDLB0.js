const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/segmentit-OucTueDK.js","assets/chunk-DECur_0Z.js"])))=>i.map(i=>d[i]);
import{r as __toESM,t as __commonJSMin}from"./chunk-DECur_0Z.js";import{$ as renderList,A as createBaseVNode,Ct as unref,E as Fragment,F as createTextVNode,G as nextTick,I as createVNode,L as defineComponent,M as createCommentVNode,N as createElementBlock,Wt as toDisplayString,Y as onMounted,Z as openBlock,ct as withCtx,gt as reactive,j as createBlock,k as computed,lt as withDirectives,nt as resolveDynamicComponent,st as watch,t as usePageSeo,tt as resolveComponent,u as PROJECTS,vt as ref}from"./head-DEUNXC35.js";import{i as useTheme,l as vModelSelect,n as __vitePreload}from"./index-C5cV1bw9.js";import{t as javascript}from"./dist-D16fNHp-.js";import{t as _plugin_vue_export_helper_default}from"./_plugin-vue_export-helper-wiDke0Jd.js";import{c as getMetaTitle,m as getPageURL,o as getMetaDescription,s as getMetaKeywords,u as getGitHubOpenGraphImageURL}from"./navbar-AOPHURom.js";import{A as normalizeExample,k as vue_default,n as card_default,t as homepage_default}from"./homepage-Dv0V-siA.js";import{n as T,t as oneDark}from"./dist-CaluLt-t.js";function ownKeys(e,t){var n=Object.keys(e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(e);t&&(r=r.filter(function(t){return Object.getOwnPropertyDescriptor(e,t).enumerable})),n.push.apply(n,r)}return n}function _objectSpread(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]==null?{}:arguments[t];t%2?ownKeys(Object(n),!0).forEach(function(t){_defineProperty(e,t,n[t])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(n)):ownKeys(Object(n)).forEach(function(t){Object.defineProperty(e,t,Object.getOwnPropertyDescriptor(n,t))})}return e}function _defineProperty(e,t,n){return t=_toPropertyKey(t),t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function _toPropertyKey(e){var t=_toPrimitive(e,`string`);return typeof t==`symbol`?t:String(t)}function _toPrimitive(e,t){if(typeof e!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t||`default`);if(typeof r!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}var dedent=createDedent({});function createDedent(e){return t.withOptions=t=>createDedent(_objectSpread(_objectSpread({},e),t)),t;function t(t,...n){let r=typeof t==`string`?[t]:t.raw,{alignValues:i=!1,escapeSpecialCharacters:a=Array.isArray(t),trimWhitespace:o=!0}=e,s=``;for(let e=0;e<r.length;e++){let t=r[e];if(a&&(t=t.replace(/\\\n[ \t]*/g,``).replace(/\\`/g,"`").replace(/\\\$/g,`$`).replace(/\\\{/g,`{`)),s+=t,e<n.length){let t=i?alignValue(n[e],s):n[e];s+=t}}let c=s.split(`
...
`).replace(/\\t/g,`	`).replace(/\\r/g,`\r`).replace(/\\v/g,`\v`).replace(/\\b/g,`\b`).replace(/\\f/g,`\f`).replace(/\\0/g,`\0`).replace(/\\x([\da-fA-F]{2})/g,(e,t)=>String.fromCharCode(parseInt(t,16))).replace(/\\u\{([\da-fA-F]{1,6})\}/g,(e,t)=>String.fromCodePoint(parseInt(t,16))).replace(/\\u([\da-fA-F]{4})/g,(e,t)=>String.fromCharCode(parseInt(t,16)))),typeof Bun<`u`&&(s=s.replace(/\\u(?:\{([\da-fA-F]{1,6})\}|([\da-fA-F]{4}))/g,(e,t,n)=>{var r;let i=t??n??``;return String.fromCodePoint(parseInt(i,16))})),s}}function alignValue(e,t){if(typeof e!=`string`||!e.includes(`
`))return e;let n=t.slice(t.lastIndexOf(`
`)+1).match(/^(\s+)/);if(n){let t=n[1];return e.replace(/\n/g,`\n${t}`)}return e}var require_naive_bayes=__commonJSMin(((e,t)=>{var n=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},r=function(){function e(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,`value`in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}();function i(e,t){if(!(e instanceof t))throw TypeError(`Cannot call a class as a function`)}var a=t.exports.STATE_KEYS=[`categories`,`docCount`,`totalDocuments`,`vocabulary`,`wordCount`,`wordFrequencyCount`,`options`],o=function(e){return e.replace(/[^(a-zA-ZA-Яa-я\u4e00-\u9fa50-9_)+\s]/g,` `).replace(/[\u4e00-\u9fa5]/g,function(e){return e+` `}).split(/\s+/)};t.exports=function(){function e(t){if(i(this,e),this.options={},t!==void 0){if(!t||(t===void 0?`undefined`:n(t))!==`object`||Array.isArray(t))throw TypeError("NaiveBayes got invalid `options`: `"+t+"`. Pass in an object.");this.options=t}this.tokenizer=this.options.tokenizer||o,this.vocabulary=[],this.totalDocuments=0,this.docCount={},this.wordCount={},this.wordFrequencyCount={},this.categories=[]}return r(e,[{key:`initializeCategory`,value:function(e){return this.categories.includes(e)||(this.docCount[e]=0,this.wordCount[e]=0,this.wordFrequencyCount[e]={},this.categories.push(e)),this}},{key:`learn`,value:function(e,t){var n=this;this.initializeCategory(t),this.docCount[t]++,this.totalDocuments++;var r=this.tokenizer(e),i=this.frequencyTable(r);return Object.keys(i).forEach(function(e){n.vocabulary.includes(e)||n.vocabulary.push(e);var r=i[e];n.wordFrequencyCount[t][e]?n.wordFrequencyCount[t][e]+=r:n.wordFrequencyCount[t][e]=r,n.wordCount[t]+=r}),this}},{key:`categorize`,value:function(e,t){return t?this.probabilities(e)[0]:this.probabilities(e)[0].category}},{key:`probabilities`,value:function(e){var t=this,n=this.tokenizer(e),r=this.frequencyTable(n);return this.categories.map(function(e){var n=t.docCount[e]/t.totalDocuments,i=Math.log(n);return Object.keys(r).forEach(function(n){var a=r[n],o=t.tokenProbability(n,e);i+=a*Math.log(o)}),{category:e,probability:i}}).sort(function(e,t){return t.probability-e.probability})}},{key:`tokenProbability`,value:function(e,t){var n=this.wordFrequencyCount[t][e]||0,r=this.wordCount[t];return(n+1)/(r+this.vocabulary.length)}},{key:`frequencyTable`,value:function(e){var t=Object.create(null);return e.forEach(function(e){t[e]?t[e]++:t[e]=1}),t}},{key:`toJson`,value:function(e){var t=e?2:0;return JSON.stringify(this.toJsonObject(),null,t)}},{key:`toJsonObject`,value:function(){var e=this,t={};return a.forEach(function(n){return t[n]=e[n]}),t}}],[{key:`fromJson`,value:function(t){if(typeof t==`string`)try{t=JSON.parse(t)}catch{throw Error(`Naivebayes.fromJson expects a valid JSON string.`)}t.options=t.options||{};var n=new e(t.options);return a.forEach(function(e){if(t[e]==null)throw Error(`NaiveBayes.fromJson: JSON string is missing an expected property: '`+e+`'.`);n[e]=t[e]}),n}}]),e}()})),import_naive_bayes=__toESM(require_naive_bayes(),1),init=dedent`
...
`,_01_base_default={name:`Base case`,factory:()=>new import_naive_bayes.default,init,code:code$3},initCode=dedent`
  import NaiveBayes from 'naivebayes'
...
`,factory=async()=>{let e=window.segmentit??await __vitePreload(()=>import(`./segmentit-OucTueDK.js`).then(e=>__toESM(e.default,1)),__vite__mapDeps([0,1]));window.segmentit=e;let{Segment:t,useDefault:n}=e,r=n(new t);return new import_naive_bayes.default({tokenizer(e){return r.doSegment(e.replace(/[^(a-zA-Z\u4e00-\u9fa50-9_)+\s]/g,` `),{simple:!0})}})},code$2=dedent`
// 正常邮件
const HAM = '正常邮件'
...
`,_02_spam_default={name:`ZH SPAM case`,factory,init:initCode,code:code$2},code$1=dedent`
// 体育新闻
const SPORTS = '体育'
...
console.log(classifier.toJson())
`,_03_news_default={name:`ZH News case`,factory,init:initCode,code:code$1},code=dedent`
// 鲁迅文章
const LuXun = '鲁迅'
...
console.log(classifier.toJson())
`,_04_writer_default={name:`ZH Writer case`,factory,init:initCode,code},normalizeInputCode=e=>`\n${e}\n`,index_vue_vue_type_script_lang_default=defineComponent({name:`naivebayes-example-base`,title:`NaiveBayes Web example`,components:{Codemirror:T},setup(){const theme=useTheme(),cases=[_01_base_default,_02_spam_default,_03_news_default,_04_writer_default],caseIndex=ref(0),codes=reactive({disabled:cases[caseIndex.value].init,enabled:normalizeInputCode(cases[caseIndex.value].code)}),log=ref(``),consoleLog=(...e)=>{window.console.log(e),log.value+=`${Array.prototype.slice.call(e).map(e=>typeof e==`string`?e:JSON.stringify(e)).join(``)}\n`},editor=ref(null),handleEditorReady=e=>{editor.value=e.view},editorExtensions=computed(()=>[javascript(),theme.isDark.value?oneDark:[]]),loading=ref(!1),runClassifier=async()=>{loading.value=!0;const classifier=await cases[caseIndex.value].factory();loading.value=!1;const console={...window.console,log:consoleLog};(classifier||console)&&eval(codes.enabled)},clearCode=()=>{codes.enabled=normalizeInputCode(dedent`
          console.log(classifier)

          // your code goes here...
        `),nextTick(()=>{editor.value?.focus()})},clearLog=()=>{log.value=``};return onMounted(()=>{watch(()=>caseIndex.value,e=>{let t=cases[e];codes.disabled=t.init,codes.enabled=normalizeInputCode(t.code),clearLog()})}),{cases,caseIndex,editorExtensions,handleEditorReady,loading,log,codes,runClassifier,clearCode,clearLog}}}),_hoisted_1={class:`example`},_hoisted_2={class:`toolbar`},_hoisted_3={class:`case`},_hoisted_4=[`value`],_hoisted_5={class:`right`},_hoisted_6=[`disabled`],_hoisted_7={key:0},_hoisted_8={class:`output`},_hoisted_9={class:`result`};function _sfc_render(e,t,n,r,i,a){let o=resolveComponent(`codemirror`);return openBlock(),createElementBlock(`div`,_hoisted_1,[createBaseVNode(`div`,_hoisted_2,[createBaseVNode(`label`,_hoisted_3,[t[6]||=createTextVNode(` Select a case: `,-1),withDirectives(createBaseVNode(`select`,{class:`select`,name:`case`,id:`case`,"onUpdate:modelValue":t[0]||=t=>e.caseIndex=t},[(openBlock(!0),createElementBlock(Fragment,null,renderList(e.cases,(e,t)=>(openBlock(),createElementBlock(`option`,{value:t,key:t},toDisplayString(e.name),9,_hoisted_4))),128))],512),[[vModelSelect,e.caseIndex]])]),createBaseVNode(`div`,_hoisted_5,[createBaseVNode(`button`,{class:`button`,onClick:t[1]||=(...t)=>e.runClassifier&&e.runClassifier(...t),disabled:e.loading},[t[7]||=createBaseVNode(`i`,{class:`iconfont icon-play`},null,-1),t[8]||=createBaseVNode(`span`,null,`Run code`,-1),e.loading?(openBlock(),createElementBlock(`span`,_hoisted_7,`\xA0(loading tokenizer...)`)):createCommentVNode(``,!0)],8,_hoisted_6),createBaseVNode(`button`,{class:`button`,onClick:t[2]||=(...t)=>e.clearLog&&e.clearLog(...t)},[...t[9]||=[createBaseVNode(`i`,{class:`iconfont icon-close`},null,-1),createBaseVNode(`span`,null,`Clear logs`,-1)]]),createBaseVNode(`button`,{class:`button`,onClick:t[3]||=(...t)=>e.clearCode&&e.clearCode(...t)},[...t[10]||=[createBaseVNode(`i`,{class:`iconfont icon-close`},null,-1),createBaseVNode(`span`,null,`Clear code`,-1)]])])]),t[12]||=createBaseVNode(`div`,{class:`divider`},null,-1),createVNode(o,{modelValue:e.codes.disabled,"onUpdate:modelValue":t[4]||=t=>e.codes.disabled=t,style:{height:`auto`},extensions:e.editorExtensions,disabled:``},null,8,[`modelValue`,`extensions`]),t[13]||=createBaseVNode(`div`,{class:`divider`},null,-1),createVNode(o,{modelValue:e.codes.enabled,"onUpdate:modelValue":t[5]||=t=>e.codes.enabled=t,extensions:e.editorExtensions,style:{minHeight:`20em`,maxHeight:`40em`},autofocus:``,onReady:e.handleEditorReady},null,8,[`modelValue`,`extensions`,`onReady`]),t[14]||=createBaseVNode(`div`,{class:`divider`},null,-1),createBaseVNode(`div`,_hoisted_8,[t[11]||=createBaseVNode(`p`,{class:`title`},`Console`,-1),createBaseVNode(`pre`,_hoisted_9,toDisplayString(e.log||`-`),1)])])}var naivebayes_default$1=_plugin_vue_export_helper_default(index_vue_vue_type_script_lang_default,[[`render`,_sfc_render],[`__scopeId`,`data-v-87f25fe8`]]),naivebayes_vue_vue_type_script_setup_true_lang_default=defineComponent({__name:`naivebayes`,setup(e){let{repository:t,route:n,packages:r}=PROJECTS.NaiveBayes,i=normalizeExample({component:naivebayes_default$1,raw:``,language:`vue`,path:`examples/naivebayes/index.vue`});return usePageSeo({title:getMetaTitle(t),keywords:getMetaKeywords(t).join(`,`),description:getMetaDescription(t),ogUrl:getPageURL(n),ogImage:getGitHubOpenGraphImageURL(t),ogImageWidth:1200,ogImageHeight:600}),(e,n)=>(openBlock(),createBlock(vue_default,{repository:unref(t)},{default:withCtx(()=>[createVNode(homepage_default,{repository:unref(t),packages:unref(r)},{content:withCtx(()=>[createVNode(card_default,{title:unref(i).title||unref(i).name,"title-link":unref(i).url},{default:withCtx(()=>[(openBlock(),createBlock(resolveDynamicComponent(unref(i).component)))]),_:1},8,[`title`,`title-link`])]),_:1},8,[`repository`,`packages`])]),_:1},8,[`repository`]))}}),naivebayes_default=naivebayes_vue_vue_type_script_setup_true_lang_default;export{naivebayes_default as default};