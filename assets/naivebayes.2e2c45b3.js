import{_ as __vitePreload,d as defineComponent,f as ref,r as reactive,g as computed,h as onMounted,w as watch,i as useTheme,T as Theme,n as nextTick,j as resolveComponent,a as openBlock,c as createElementBlock,e as createBaseVNode,k as withDirectives,v as vModelSelect,F as Fragment,l as renderList,t as toDisplayString,m as createCommentVNode,q as createVNode,s as createTextVNode,p as pushScopeId,b as popScopeId,P as PROJECTS,u as useMeta,x as createBlock,y as withCtx,z as unref,B as resolveDynamicComponent}from"./index.4cf9d382.js";import{g as getExampleComponent,H as Homepage}from"./index.dd57730c.js";import{g as getMetaTitle,a as getMetaKeywords,b as getMetaDescription}from"./navbar.739cea44.js";import{V as VueRenderer}from"./vue.763564f6.js";import{H as HomepageExamples}from"./examples.f41994b7.js";import{V,o as oneDark}from"./index.79b890f9.js";import{j as javascript}from"./index.5deeb56b.js";import{_ as _export_sfc}from"./_plugin-vue_export-helper.cdc0426e.js";import"./index.4335a6a7.js";var dedent$1={exports:{}};(function(e){function n(s){var o=void 0;typeof s=="string"?o=[s]:o=s.raw;for(var a="",t=0;t<o.length;t++)a+=o[t].replace(/\\\n[ \t]*/g,"").replace(/\\`/g,"`"),t<(arguments.length<=1?0:arguments.length-1)&&(a+=arguments.length<=t+1?void 0:arguments[t+1]);var r=a.split(`
`),i=null;return r.forEach(function(l){var c=l.match(/^(\s+)\S+/);if(c){var d=c[1].length;i?i=Math.min(i,d):i=d}}),i!==null&&(a=r.map(function(l){return l[0]===" "?l.slice(i):l}).join(`
`)),a=a.trim(),a.replace(/\\n/g,`
`)}e.exports=n})(dedent$1);const dedent=dedent$1.exports;var naiveBayes={exports:{}},_typeof=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},_createClass=function(){function e(n,s){for(var o=0;o<s.length;o++){var a=s[o];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(n,a.key,a)}}return function(n,s,o){return s&&e(n.prototype,s),o&&e(n,o),n}}();function _classCallCheck(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}var STATE_KEYS=naiveBayes.exports.STATE_KEYS=["categories","docCount","totalDocuments","vocabulary","wordCount","wordFrequencyCount","options"],defaultTokenizer=function(n){var s=/[^(a-zA-ZA-Яa-я\u4e00-\u9fa50-9_)+\s]/g;return n.replace(s," ").replace(/[\u4e00-\u9fa5]/g,function(o){return o+" "}).split(/\s+/)},NaiveBayes=function(){function e(n){if(_classCallCheck(this,e),this.options={},typeof n<"u"){if(!n||(typeof n>"u"?"undefined":_typeof(n))!=="object"||Array.isArray(n))throw TypeError("NaiveBayes got invalid `options`: `"+n+"`. Pass in an object.");this.options=n}this.tokenizer=this.options.tokenizer||defaultTokenizer,this.vocabulary=[],this.totalDocuments=0,this.docCount={},this.wordCount={},this.wordFrequencyCount={},this.categories=[]}return _createClass(e,[{key:"initializeCategory",value:function(s){return this.categories.includes(s)||(this.docCount[s]=0,this.wordCount[s]=0,this.wordFrequencyCount[s]={},this.categories.push(s)),this}},{key:"learn",value:function(s,o){var a=this;this.initializeCategory(o),this.docCount[o]++,this.totalDocuments++;var t=this.tokenizer(s),r=this.frequencyTable(t);return Object.keys(r).forEach(function(i){a.vocabulary.includes(i)||a.vocabulary.push(i);var l=r[i];a.wordFrequencyCount[o][i]?a.wordFrequencyCount[o][i]+=l:a.wordFrequencyCount[o][i]=l,a.wordCount[o]+=l}),this}},{key:"categorize",value:function(s,o){return o?this.probabilities(s)[0]:this.probabilities(s)[0].category}},{key:"probabilities",value:function(s){var o=this,a=this.tokenizer(s),t=this.frequencyTable(a);return this.categories.map(function(r){var i=o.docCount[r]/o.totalDocuments,l=Math.log(i);return Object.keys(t).forEach(function(c){var d=t[c],u=o.tokenProbability(c,r);l+=d*Math.log(u)}),{category:r,probability:l}}).sort(function(r,i){return i.probability-r.probability})}},{key:"tokenProbability",value:function(s,o){var a=this.wordFrequencyCount[o][s]||0,t=this.wordCount[o];return(a+1)/(t+this.vocabulary.length)}},{key:"frequencyTable",value:function(s){var o=Object.create(null);return s.forEach(function(a){o[a]?o[a]++:o[a]=1}),o}},{key:"toJson",value:function(s){var o=s?2:0;return JSON.stringify(this.toJsonObject(),null,o)}},{key:"toJsonObject",value:function(){var s=this,o={};return STATE_KEYS.forEach(function(a){return o[a]=s[a]}),o}}],[{key:"fromJson",value:function(s){if(typeof s=="string")try{s=JSON.parse(s)}catch{throw new Error("Naivebayes.fromJson expects a valid JSON string.")}s.options=s.options||{};var o=new e(s.options);return STATE_KEYS.forEach(function(a){if(s[a]==null)throw new Error("NaiveBayes.fromJson: JSON string is missing an expected property: '"+a+"'.");o[a]=s[a]}),o}}]),e}();naiveBayes.exports=NaiveBayes;const init=dedent`
...
`,case1={name:"Base case",factory:()=>new naiveBayes.exports,init,code:code$3},initCode=dedent`
  import NaiveBayes from 'naivebayes'
...
`,factory=async()=>{var a;const e=(a=window.segmentit)!=null?a:await __vitePreload(()=>import("./segmentit.4e215cd8.js"),[]);window.segmentit=e;const{Segment:n,useDefault:s}=e,o=s(new n);return new naiveBayes.exports({tokenizer(t){return o.doSegment(t.replace(/[^(a-zA-Z\u4e00-\u9fa50-9_)+\s]/g," "),{simple:!0})}})},code$2=dedent`
// 正常邮件
const HAM = '正常邮件'
...
`,_hoisted_1={class:"naivebayes-example"},_sfc_main=defineComponent({__name:"naivebayes",setup(e){const{repository:n,packages:s}=PROJECTS.NaiveBayes,o=getExampleComponent({component:exampleComponent,raw:exampleComponentString,language:"vue"});return useMeta({title:getMetaTitle(n),keywords:getMetaKeywords(n).join(","),description:getMetaDescription(n)}),(a,t)=>(openBlock(),createBlock(VueRenderer,{repository:unref(n)},{default:withCtx(()=>[createVNode(Homepage,{repository:unref(n),packages:unref(s)},{content:withCtx(()=>[createVNode(HomepageExamples,{examples:[unref(o)],"disabled-auto-ad":!0},{component:withCtx(r=>[createBaseVNode("div",_hoisted_1,[(openBlock(),createBlock(resolveDynamicComponent(r.component)))])]),_:1},8,["examples"])]),_:1},8,["repository","packages"])]),_:1},8,["repository"]))}});export{_sfc_main as default};
