var v=Object.defineProperty,h=Object.defineProperties;var y=Object.getOwnPropertyDescriptors;var u=Object.getOwnPropertySymbols;var b=Object.prototype.hasOwnProperty,_=Object.prototype.propertyIsEnumerable;var f=(e,n,o)=>n in e?v(e,n,{enumerable:!0,configurable:!0,writable:!0,value:o}):e[n]=o,p=(e,n)=>{for(var o in n||(n={}))b.call(n,o)&&f(e,o,n[o]);if(u)for(var o of u(n))_.call(n,o)&&f(e,o,n[o]);return e},m=(e,n)=>h(e,y(n));import{_ as __vitePreload,b as useTheme,T as Theme,R as Repository,u as useMeta}from"./index.a51fdbad.js";import{g as getExampleComponent,H as Homepage}from"./index.21bef323.js";import{g as getMetaTitle,a as getMetaKeywords,b as getMetaDescription}from"./navbar.a89cfa83.js";import{V as VueRenderer}from"./vue.8d6cac2f.js";import{H as HomepageExamples}from"./examples.575b6a3c.js";import{i as defineComponent,q as ref,z as reactive,v as computed,a0 as onMounted,a1 as watch,a2 as nextTick,E as resolveComponent,F as openBlock,M as createElementBlock,P as createBaseVNode,a3 as withDirectives,a4 as vModelSelect,S as Fragment,T as renderList,V as toDisplayString,Z as createCommentVNode,U as createVNode,Y as createTextVNode,N as pushScopeId,O as popScopeId,G as createBlock,Q as withCtx,R as unref,a5 as resolveDynamicComponent}from"./vendor.9ced2005.js";import{F}from"./vue-codemirror.esm.00e53fca.js";import{j as javascript}from"./index.0ce77fbc.js";import{o as oneDark}from"./index.e721b1cd.js";import{_ as _export_sfc}from"./plugin-vue_export-helper.21dcd24c.js";var dedent$1={exports:{}};(function(e){function n(o){var s=void 0;typeof o=="string"?s=[o]:s=o.raw;for(var a="",t=0;t<s.length;t++)a+=s[t].replace(/\\\n[ \t]*/g,"").replace(/\\`/g,"`"),t<(arguments.length<=1?0:arguments.length-1)&&(a+=arguments.length<=t+1?void 0:arguments[t+1]);var l=a.split(`
`),i=null;return l.forEach(function(r){var c=r.match(/^(\s+)\S+/);if(c){var d=c[1].length;i?i=Math.min(i,d):i=d}}),i!==null&&(a=l.map(function(r){return r[0]===" "?r.slice(i):r}).join(`
`)),a=a.trim(),a.replace(/\\n/g,`
`)}e.exports=n})(dedent$1);var dedent=dedent$1.exports,naiveBayes={exports:{}},_typeof=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},_createClass=function(){function e(n,o){for(var s=0;s<o.length;s++){var a=o[s];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(n,a.key,a)}}return function(n,o,s){return o&&e(n.prototype,o),s&&e(n,s),n}}();function _classCallCheck(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}var STATE_KEYS=naiveBayes.exports.STATE_KEYS=["categories","docCount","totalDocuments","vocabulary","wordCount","wordFrequencyCount","options"],defaultTokenizer=function(n){var o=/[^(a-zA-ZA-Яa-я\u4e00-\u9fa50-9_)+\s]/g;return n.replace(o," ").replace(/[\u4e00-\u9fa5]/g,function(s){return s+" "}).split(/\s+/)},NaiveBayes=function(){function e(n){if(_classCallCheck(this,e),this.options={},typeof n!="undefined"){if(!n||(typeof n=="undefined"?"undefined":_typeof(n))!=="object"||Array.isArray(n))throw TypeError("NaiveBayes got invalid `options`: `"+n+"`. Pass in an object.");this.options=n}this.tokenizer=this.options.tokenizer||defaultTokenizer,this.vocabulary=[],this.totalDocuments=0,this.docCount={},this.wordCount={},this.wordFrequencyCount={},this.categories=[]}return _createClass(e,[{key:"initializeCategory",value:function(o){return this.categories.includes(o)||(this.docCount[o]=0,this.wordCount[o]=0,this.wordFrequencyCount[o]={},this.categories.push(o)),this}},{key:"learn",value:function(o,s){var a=this;this.initializeCategory(s),this.docCount[s]++,this.totalDocuments++;var t=this.tokenizer(o),l=this.frequencyTable(t);return Object.keys(l).forEach(function(i){a.vocabulary.includes(i)||a.vocabulary.push(i);var r=l[i];a.wordFrequencyCount[s][i]?a.wordFrequencyCount[s][i]+=r:a.wordFrequencyCount[s][i]=r,a.wordCount[s]+=r}),this}},{key:"categorize",value:function(o,s){return s?this.probabilities(o)[0]:this.probabilities(o)[0].category}},{key:"probabilities",value:function(o){var s=this,a=this.tokenizer(o),t=this.frequencyTable(a);return this.categories.map(function(l){var i=s.docCount[l]/s.totalDocuments,r=Math.log(i);return Object.keys(t).forEach(function(c){var d=t[c],g=s.tokenProbability(c,l);r+=d*Math.log(g)}),{category:l,probability:r}}).sort(function(l,i){return i.probability-l.probability})}},{key:"tokenProbability",value:function(o,s){var a=this.wordFrequencyCount[s][o]||0,t=this.wordCount[s];return(a+1)/(t+this.vocabulary.length)}},{key:"frequencyTable",value:function(o){var s=Object.create(null);return o.forEach(function(a){s[a]?s[a]++:s[a]=1}),s}},{key:"toJson",value:function(o){var s=o?2:0;return JSON.stringify(this.toJsonObject(),null,s)}},{key:"toJsonObject",value:function(){var o=this,s={};return STATE_KEYS.forEach(function(a){return s[a]=o[a]}),s}}],[{key:"fromJson",value:function(o){if(typeof o=="string")try{o=JSON.parse(o)}catch{throw new Error("Naivebayes.fromJson expects a valid JSON string.")}o.options=o.options||{};var s=new e(o.options);return STATE_KEYS.forEach(function(a){if(o[a]==null)throw new Error("NaiveBayes.fromJson: JSON string is missing an expected property: '"+a+"'.");s[a]=o[a]}),s}}]),e}();naiveBayes.exports=NaiveBayes;var NaiveBayes$1=naiveBayes.exports;const init=dedent`
...
`;var case1={name:"Base case",factory:()=>new NaiveBayes$1,init,code:code$3};const initCode=dedent`
  import NaiveBayes from 'naivebayes'
...
`,factory=async()=>{var a;const e=(a=window.segmentit)!=null?a:await __vitePreload(()=>import("./segmentit.4e215cd8.js"),[]);window.segmentit=e;const{Segment:n,useDefault:o}=e,s=o(new n);return new NaiveBayes$1({tokenizer(t){return s.doSegment(t.replace(/[^(a-zA-Z\u4e00-\u9fa50-9_)+\s]/g," "),{simple:!0})}})},code$2=dedent`
// 正常邮件
const HAM = '正常邮件'
...
`;var case2={name:"ZH SPAM case",factory,init:initCode,code:code$2};const code$1=dedent`
// 体育新闻
const SPORTS = '体育'
...
console.log(classifier.toJson())
`;var case3={name:"ZH News case",factory,init:initCode,code:code$1};const code=dedent`
// 鲁迅文章
const LuXun = '鲁迅'
...
console.log(classifier.toJson())
`;var case4={name:"ZH Writer case",factory,init:initCode,code},index_vue_vue_type_style_index_0_scoped_true_lang="";const normalizeInputCode=e=>`
${e}
`,_sfc_main$1=defineComponent({name:"naivebayes-example-base",title:"NaiveBayes Web example",url:"file:///examples/naivebayes/index.vue",components:{Codemirror:F},setup(){const cases=[case1,case2,case3,case4],caseIndex=ref(0),codes=reactive({disabled:cases[caseIndex.value].init,enabled:normalizeInputCode(cases[caseIndex.value].code)}),log=ref(""),consoleLog=(...e)=>{window.console.log(e),log.value+=`${Array.prototype.slice.call(e).map(n=>typeof n=="string"?n:JSON.stringify(n)).join("")}
`},editor=ref(null),handleEditorReady=e=>{editor.value=e.view},editorExtensions=computed(()=>[javascript(),useTheme().theme.value===Theme.Dark?oneDark:[]]),loading=ref(!1),runClassifier=async()=>{loading.value=!0;const classifier=await cases[caseIndex.value].factory();loading.value=!1;const console=m(p({},window.console),{log:consoleLog});(classifier||console)&&eval(codes.enabled)},clearCode=()=>{codes.enabled=normalizeInputCode(dedent`
          console.log(classifier)

          // your code goes here...
        `),nextTick(()=>{var e;(e=editor.value)==null||e.focus()})},clearLog=()=>{log.value=""};return onMounted(()=>{watch(()=>caseIndex.value,e=>{const n=cases[e];codes.disabled=n.init,codes.enabled=normalizeInputCode(n.code),clearLog()})}),{cases,caseIndex,editorExtensions,handleEditorReady,loading,log,codes,runClassifier,clearCode,clearLog}}}),_withScopeId=e=>(pushScopeId("data-v-39e2c912"),e=e(),popScopeId(),e),_hoisted_1$1={class:"example"},_hoisted_2={class:"toolbar"},_hoisted_3={class:"case"},_hoisted_4=createTextVNode(" Select a case: "),_hoisted_5=["value"],_hoisted_6={class:"right"},_hoisted_7=["disabled"],_hoisted_8=_withScopeId(()=>createBaseVNode("i",{class:"iconfont icon-play"},null,-1)),_hoisted_9=_withScopeId(()=>createBaseVNode("span",null,"Run code",-1)),_hoisted_10={key:0},_hoisted_11=_withScopeId(()=>createBaseVNode("i",{class:"iconfont icon-close"},null,-1)),_hoisted_12=_withScopeId(()=>createBaseVNode("span",null,"Clear logs",-1)),_hoisted_13=[_hoisted_11,_hoisted_12],_hoisted_14=_withScopeId(()=>createBaseVNode("i",{class:"iconfont icon-close"},null,-1)),_hoisted_15=_withScopeId(()=>createBaseVNode("span",null,"Clear code",-1)),_hoisted_16=[_hoisted_14,_hoisted_15],_hoisted_17=_withScopeId(()=>createBaseVNode("div",{class:"divider"},null,-1)),_hoisted_18=_withScopeId(()=>createBaseVNode("div",{class:"divider"},null,-1)),_hoisted_19=_withScopeId(()=>createBaseVNode("div",{class:"divider"},null,-1)),_hoisted_20={class:"output"},_hoisted_21=_withScopeId(()=>createBaseVNode("p",{class:"title"},"Console",-1)),_hoisted_22={class:"result"};function _sfc_render(e,n,o,s,a,t){const l=resolveComponent("codemirror");return openBlock(),createElementBlock("div",_hoisted_1$1,[createBaseVNode("div",_hoisted_2,[createBaseVNode("label",_hoisted_3,[_hoisted_4,withDirectives(createBaseVNode("select",{class:"select",name:"case",id:"case","onUpdate:modelValue":n[0]||(n[0]=i=>e.caseIndex=i)},[(openBlock(!0),createElementBlock(Fragment,null,renderList(e.cases,(i,r)=>(openBlock(),createElementBlock("option",{value:r,key:r},toDisplayString(i.name),9,_hoisted_5))),128))],512),[[vModelSelect,e.caseIndex]])]),createBaseVNode("div",_hoisted_6,[createBaseVNode("button",{class:"button",onClick:n[1]||(n[1]=(...i)=>e.runClassifier&&e.runClassifier(...i)),disabled:e.loading},[_hoisted_8,_hoisted_9,e.loading?(openBlock(),createElementBlock("span",_hoisted_10,"\xA0(loading tokenizer...)")):createCommentVNode("",!0)],8,_hoisted_7),createBaseVNode("button",{class:"button",onClick:n[2]||(n[2]=(...i)=>e.clearLog&&e.clearLog(...i))},_hoisted_13),createBaseVNode("button",{class:"button",onClick:n[3]||(n[3]=(...i)=>e.clearCode&&e.clearCode(...i))},_hoisted_16)])]),_hoisted_17,createVNode(l,{modelValue:e.codes.disabled,"onUpdate:modelValue":n[4]||(n[4]=i=>e.codes.disabled=i),style:{height:"auto"},extensions:e.editorExtensions,disabled:""},null,8,["modelValue","extensions"]),_hoisted_18,createVNode(l,{modelValue:e.codes.enabled,"onUpdate:modelValue":n[5]||(n[5]=i=>e.codes.enabled=i),extensions:e.editorExtensions,style:{minHeight:"20em",maxHeight:"40em"},autofocus:"",onReady:e.handleEditorReady},null,8,["modelValue","extensions","onReady"]),_hoisted_19,createBaseVNode("div",_hoisted_20,[_hoisted_21,createBaseVNode("pre",_hoisted_22,toDisplayString(e.log||"-"),1)])])}var exampleComponent=_export_sfc(_sfc_main$1,[["render",_sfc_render],["__scopeId","data-v-39e2c912"]]),exampleComponentString=`<template>
  <div class="example">
    <div class="toolbar">
      <label class="case">
        Select a case:
...
`;const _hoisted_1={class:"naivebayes-example"},_sfc_main=defineComponent({setup(e){const n=Repository.NaiveBayes,o=getExampleComponent({component:exampleComponent,raw:exampleComponentString,language:"vue"});return useMeta({title:getMetaTitle(n),keywords:getMetaKeywords(n).join(","),description:getMetaDescription(n)}),(s,a)=>(openBlock(),createBlock(VueRenderer,{repository:unref(n)},{default:withCtx(()=>[createVNode(Homepage,{repository:unref(n)},{content:withCtx(()=>[createVNode(HomepageExamples,{examples:[unref(o)],"disabled-auto-ad":!0},{component:withCtx(t=>[createBaseVNode("div",_hoisted_1,[(openBlock(),createBlock(resolveDynamicComponent(t.component)))])]),_:1},8,["examples"])]),_:1},8,["repository"])]),_:1},8,["repository"]))}});export{_sfc_main as default};
