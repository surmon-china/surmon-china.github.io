import{_ as __vitePreload,d as defineComponent,f as ref,r as reactive,g as computed,h as onMounted,w as watch,n as nextTick,i as useTheme,T as Theme,a as openBlock,c as createElementBlock,e as createBaseVNode,j as createTextVNode,k as withDirectives,v as vModelSelect,F as Fragment,l as renderList,t as toDisplayString,m as createCommentVNode,q as createVNode,s as resolveComponent,p as pushScopeId,b as popScopeId,P as PROJECTS,u as useMeta,x as createBlock,y as withCtx,z as unref,B as resolveDynamicComponent}from"./index-00925d93.js";import{g as getExampleComponent,H as Homepage}from"./index-1abbf20c.js";import{g as getMetaTitle,a as getMetaKeywords,b as getMetaDescription,c as getGitHubOpenGraphImageURL,d as getPageURL}from"./navbar-8b47ce90.js";import{V as VueRenderer}from"./vue-c82dd579.js";import{H as HomepageExamples}from"./examples-9611f8be.js";import{T,o as oneDark}from"./index-ac4dde34.js";import{j as javascript}from"./index-dedcad36.js";import{_ as _export_sfc}from"./_plugin-vue_export-helper-c27b6911.js";import"./index-59a48ff4.js";var dedentExports={},dedent$1={get exports(){return dedentExports},set exports(e){dedentExports=e}};(function(e){function n(s){var o=void 0;typeof s=="string"?o=[s]:o=s.raw;for(var a="",i=0;i<o.length;i++)a+=o[i].replace(/\\\n[ \t]*/g,"").replace(/\\`/g,"`"),i<(arguments.length<=1?0:arguments.length-1)&&(a+=arguments.length<=i+1?void 0:arguments[i+1]);var r=a.split(`
`),t=null;return r.forEach(function(l){var c=l.match(/^(\s+)\S+/);if(c){var d=c[1].length;t?t=Math.min(t,d):t=d}}),t!==null&&(a=r.map(function(l){return l[0]===" "?l.slice(t):l}).join(`
`)),a=a.trim(),a.replace(/\\n/g,`
`)}e.exports=n})(dedent$1);const dedent=dedentExports;var naiveBayesExports={},naiveBayes={get exports(){return naiveBayesExports},set exports(e){naiveBayesExports=e}},_typeof=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},_createClass=function(){function e(n,s){for(var o=0;o<s.length;o++){var a=s[o];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(n,a.key,a)}}return function(n,s,o){return s&&e(n.prototype,s),o&&e(n,o),n}}();function _classCallCheck(e,n){if(!(e instanceof n))throw new TypeError("Cannot call a class as a function")}var STATE_KEYS=naiveBayesExports.STATE_KEYS=["categories","docCount","totalDocuments","vocabulary","wordCount","wordFrequencyCount","options"],defaultTokenizer=function(n){var s=/[^(a-zA-ZA-Яa-я\u4e00-\u9fa50-9_)+\s]/g;return n.replace(s," ").replace(/[\u4e00-\u9fa5]/g,function(o){return o+" "}).split(/\s+/)},NaiveBayes=function(){function e(n){if(_classCallCheck(this,e),this.options={},typeof n<"u"){if(!n||(typeof n>"u"?"undefined":_typeof(n))!=="object"||Array.isArray(n))throw TypeError("NaiveBayes got invalid `options`: `"+n+"`. Pass in an object.");this.options=n}this.tokenizer=this.options.tokenizer||defaultTokenizer,this.vocabulary=[],this.totalDocuments=0,this.docCount={},this.wordCount={},this.wordFrequencyCount={},this.categories=[]}return _createClass(e,[{key:"initializeCategory",value:function(s){return this.categories.includes(s)||(this.docCount[s]=0,this.wordCount[s]=0,this.wordFrequencyCount[s]={},this.categories.push(s)),this}},{key:"learn",value:function(s,o){var a=this;this.initializeCategory(o),this.docCount[o]++,this.totalDocuments++;var i=this.tokenizer(s),r=this.frequencyTable(i);return Object.keys(r).forEach(function(t){a.vocabulary.includes(t)||a.vocabulary.push(t);var l=r[t];a.wordFrequencyCount[o][t]?a.wordFrequencyCount[o][t]+=l:a.wordFrequencyCount[o][t]=l,a.wordCount[o]+=l}),this}},{key:"categorize",value:function(s,o){return o?this.probabilities(s)[0]:this.probabilities(s)[0].category}},{key:"probabilities",value:function(s){var o=this,a=this.tokenizer(s),i=this.frequencyTable(a);return this.categories.map(function(r){var t=o.docCount[r]/o.totalDocuments,l=Math.log(t);return Object.keys(i).forEach(function(c){var d=i[c],u=o.tokenProbability(c,r);l+=d*Math.log(u)}),{category:r,probability:l}}).sort(function(r,t){return t.probability-r.probability})}},{key:"tokenProbability",value:function(s,o){var a=this.wordFrequencyCount[o][s]||0,i=this.wordCount[o];return(a+1)/(i+this.vocabulary.length)}},{key:"frequencyTable",value:function(s){var o=Object.create(null);return s.forEach(function(a){o[a]?o[a]++:o[a]=1}),o}},{key:"toJson",value:function(s){var o=s?2:0;return JSON.stringify(this.toJsonObject(),null,o)}},{key:"toJsonObject",value:function(){var s=this,o={};return STATE_KEYS.forEach(function(a){return o[a]=s[a]}),o}}],[{key:"fromJson",value:function(s){if(typeof s=="string")try{s=JSON.parse(s)}catch{throw new Error("Naivebayes.fromJson expects a valid JSON string.")}s.options=s.options||{};var o=new e(s.options);return STATE_KEYS.forEach(function(a){if(s[a]==null)throw new Error("NaiveBayes.fromJson: JSON string is missing an expected property: '"+a+"'.");o[a]=s[a]}),o}}]),e}();naiveBayes.exports=NaiveBayes;const init=dedent`
...
`,case1={name:"Base case",factory:()=>new naiveBayesExports,init,code:code$3},initCode=dedent`
  import NaiveBayes from 'naivebayes'
...
`,factory=async()=>{const e=window.segmentit??await __vitePreload(()=>import("./segmentit-0a0dd407.js"),[]);window.segmentit=e;const{Segment:n,useDefault:s}=e,o=s(new n);return new naiveBayesExports({tokenizer(a){return o.doSegment(a.replace(/[^(a-zA-Z\u4e00-\u9fa50-9_)+\s]/g," "),{simple:!0})}})},code$2=dedent`
// 正常邮件
const HAM = '正常邮件'
...
`},editor=ref(null),handleEditorReady=e=>{editor.value=e.view},editorExtensions=computed(()=>[javascript(),useTheme().theme.value===Theme.Dark?oneDark:[]]),loading=ref(!1),runClassifier=async()=>{loading.value=!0;const classifier=await cases[caseIndex.value].factory();loading.value=!1;const console={...window.console,log:consoleLog};(classifier||console)&&eval(codes.enabled)},clearCode=()=>{codes.enabled=normalizeInputCode(dedent`
          ...
          // your code goes here...
        `),nextTick(()=>{var e;(e=editor.value)==null||e.focus()})},clearLog=()=>{log.value=""};return onMounted(()=>{watch(()=>caseIndex.value,e=>{const n=cases[e];codes.disabled=n.init,codes.enabled=normalizeInputCode(n.code),clearLog()})}),{cases,caseIndex,editorExtensions,handleEditorReady,loading,log,codes,runClassifier,clearCode,clearLog}}}),index_vue_vue_type_style_index_0_scoped_2269e3ab_lang="",_withScopeId=e=>(pushScopeId("data-v-2269e3ab"),e=e(),popScopeId(),e),_hoisted_1$1={class:"example"},_hoisted_2={class:"toolbar"},_hoisted_3={class:"case"},_hoisted_4=["value"],_hoisted_5={class:"right"},_hoisted_6=["disabled"],_hoisted_7=_withScopeId(()=>createBaseVNode("i",{class:"iconfont icon-play"},null,-1)),_hoisted_8=_withScopeId(()=>createBaseVNode("span",null,"Run code",-1)),_hoisted_9={key:0},_hoisted_10=_withScopeId(()=>createBaseVNode("i",{class:"iconfont icon-close"},null,-1)),_hoisted_11=_withScopeId(()=>createBaseVNode("span",null,"Clear logs",-1)),_hoisted_12=[_hoisted_10,_hoisted_11],_hoisted_13=_withScopeId(()=>createBaseVNode("i",{class:"iconfont icon-close"},null,-1)),_hoisted_14=_withScopeId(()=>createBaseVNode("span",null,"Clear code",-1)),_hoisted_15=[_hoisted_13,_hoisted_14],_hoisted_16=_withScopeId(()=>createBaseVNode("div",{class:"divider"},null,-1)),_hoisted_17=_withScopeId(()=>createBaseVNode("div",{class:"divider"},null,-1)),_hoisted_18=_withScopeId(()=>createBaseVNode("div",{class:"divider"},null,-1)),_hoisted_19={class:"output"},_hoisted_20=_withScopeId(()=>createBaseVNode("p",{class:"title"},"Console",-1)),_hoisted_21={class:"result"};function _sfc_render(e,n,s,o,a,i){const r=resolveComponent("codemirror");return openBlock(),createElementBlock("div",_hoisted_1$1,[createBaseVNode("div",_hoisted_2,[createBaseVNode("label",_hoisted_3,[createTextVNode(" Select a case: "),withDirectives(createBaseVNode("select",{class:"select",name:"case",id:"case","onUpdate:modelValue":n[0]||(n[0]=t=>e.caseIndex=t)},[(openBlock(!0),createElementBlock(Fragment,null,renderList(e.cases,(t,l)=>(openBlock(),createElementBlock("option",{value:l,key:l},toDisplayString(t.name),9,_hoisted_4))),128))],512),[[vModelSelect,e.caseIndex]])]),createBaseVNode("div",_hoisted_5,[createBaseVNode("button",{class:"button",onClick:n[1]||(n[1]=(...t)=>e.runClassifier&&e.runClassifier(...t)),disabled:e.loading},[_hoisted_7,_hoisted_8,e.loading?(openBlock(),createElementBlock("span",_hoisted_9," (loading tokenizer...)")):createCommentVNode("",!0)],8,_hoisted_6),createBaseVNode("button",{class:"button",onClick:n[2]||(n[2]=(...t)=>e.clearLog&&e.clearLog(...t))},_hoisted_12),createBaseVNode("button",{class:"button",onClick:n[3]||(n[3]=(...t)=>e.clearCode&&e.clearCode(...t))},_hoisted_15)])]),_hoisted_16,createVNode(r,{modelValue:e.codes.disabled,"onUpdate:modelValue":n[4]||(n[4]=t=>e.codes.disabled=t),style:{height:"auto"},extensions:e.editorExtensions,disabled:""},null,8,["modelValue","extensions"]),_hoisted_17,createVNode(r,{modelValue:e.codes.enabled,"onUpdate:modelValue":n[5]||(n[5]=t=>e.codes.enabled=t),extensions:e.editorExtensions,style:{minHeight:"20em",maxHeight:"40em"},autofocus:"",onReady:e.handleEditorReady},null,8,["modelValue","extensions","onReady"]),_hoisted_18,createBaseVNode("div",_hoisted_19,[_hoisted_20,createBaseVNode("pre",_hoisted_21,toDisplayString(e.log||"-"),1)])])}const exampleComponent=_export_sfc(_sfc_main$1,[["render",_sfc_render],["__scopeId","data-v-2269e3ab"]]),exampleComponentString=`<template>
  <div class="example">
    <div class="toolbar">
      <label class="case">
        Select a case:
...
`,_hoisted_1={class:"naivebayes-example"},_sfc_main=defineComponent({__name:"naivebayes",setup(e){const{repository:n,route:s,packages:o}=PROJECTS.NaiveBayes,a=getExampleComponent({component:exampleComponent,raw:exampleComponentString,language:"vue"});return useMeta({title:getMetaTitle(n),keywords:getMetaKeywords(n).join(","),description:getMetaDescription(n),ogImage:getGitHubOpenGraphImageURL(n),ogUrl:getPageURL(s)}),(i,r)=>(openBlock(),createBlock(VueRenderer,{repository:unref(n)},{default:withCtx(()=>[createVNode(Homepage,{repository:unref(n),packages:unref(o)},{content:withCtx(()=>[createVNode(HomepageExamples,{examples:[unref(a)],"disabled-auto-ad":!0},{component:withCtx(t=>[createBaseVNode("div",_hoisted_1,[(openBlock(),createBlock(resolveDynamicComponent(t.component)))])]),_:1},8,["examples"])]),_:1},8,["repository","packages"])]),_:1},8,["repository"]))}});export{_sfc_main as default};
