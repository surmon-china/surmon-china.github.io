...
`};var Sp=Object.keys(Le).map(t=>({component:Le[t].default,raw:vp[t],language:"vue"}));const bp={class:"swiper-example"},yp=L({setup(t){const e=qe.VueAwesomeSwiper,v=Sp.map(Ke);return Ge({title:Qe(e),keywords:[es(e),"How to use Swiper on vue3?"].join(","),description:ss(e)}),(u,S)=>(P(),Y(rs,{repository:ce(e)},{default:r(()=>[n(Ze,{repository:ce(e)},{actions:r(()=>[n(Se,{icon:"doc",text:"Vue(2) examples",href:ce(Be)(ce(e))},null,8,["href"]),n(Se,{icon:"doc",text:"Swiper API Documentation",href:"https://swiperjs.com/swiper-api"}),n(Se,{icon:"doc",text:"Swiper Vue(3) component",href:"https://swiperjs.com/vue"}),n(Se,{icon:"discussions",text:"Swiper discussions",href:"https://github.com/nolimits4web/swiper/discussions"})]),content:r(()=>[n(Je,{examples:ce(v)},{component:r(h=>[$("div",bp,[(P(),Y(as(h.component)))])]),_:1},8,["examples"])]),_:1},8,["repository"])]),_:1},8,["repository"]))}});var Tp=H(yp,[["__scopeId","data-v-0d6cf728"]]);export{Tp as default};
