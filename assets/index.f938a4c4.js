...
print(s1 >= s1)       --> true
print(s1 > s1)        --> false
print(s1 == s2 * s1)  --> true`,x={language:()=>d.define(k),code:v};export{x as default};
