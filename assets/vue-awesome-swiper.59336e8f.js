...
`};var uh=Object.keys(xs).map(s=>({component:xs[s].default,raw:ch[s],language:"vue"}));const fh={class:"page"},mh={class:"swiper-example"},hh=R({setup(s){const e=rt.VueAwesomeSwiper,t=uh.map(xt);return nt({title:ut(e),keywords:[ft(e),"How to use Swiper on vue3?"].join(","),description:mt(e)}),(i,l)=>(O(),W("div",fh,[m(Hn,{repository:oe(e)},{actions:f(()=>[m(Be,{icon:"doc",text:"Vue(2) examples",href:oe(lt)(oe(e))},null,8,["href"]),m(Be,{icon:"doc",text:"Swiper API Documentation",href:"https://swiperjs.com/swiper-api"}),m(Be,{icon:"doc",text:"Swiper Vue(3) component",href:"https://swiperjs.com/vue"}),m(Be,{icon:"discussions",text:"Swiper discussions",href:"https://github.com/nolimits4web/swiper/discussions"})]),content:f(()=>[m(pl,{examples:oe(t)},{component:f(n=>[E("div",mh,[(O(),V(yt(n.component)))])]),_:1},8,["examples"])]),_:1},8,["repository"])]))}});var yh=H(hh,[["__scopeId","data-v-76ee8fde"]]);export{yh as default};
